...
class TestBanHelperFunctions(unittest.TestCase):
    ...
    def test_can_user_comment(self):
        ...
        self.assertTrue(can_user_comment(self.portal, "shadow_banned_user"))  # Shadow bans can comment
        self.assertFalse(can_user_comment(self.portal, "cooldown_user"))  # Cooldown bans can't comment
        self.assertFalse(can_user_comment(self.portal, "permanent_user"))  # Permanent bans can't comment
    ...
    def test_is_comment_visible(self):
        ...
        self.assertFalse(is_comment_visible(self.portal, "shadow_banned_user"))  # Shadow banned comments are hidden
        self.assertTrue(is_comment_visible(self.portal, "cooldown_user"))  # Cooldown ban comments still visible
        self.assertTrue(is_comment_visible(self.portal, "permanent_user"))  # Permanent ban comments still visible
