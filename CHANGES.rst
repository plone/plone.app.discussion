...
Edit Comments (to be merged)
----------------------------

- update changelog
  [Guido A.J. Stevens]

- fix test regressions caused by merge
  [Guido A.J. Stevens]

- Merge branch 'master' into edit-comments
  [Guido A.J. Stevens]

- add additional test coverage on 99ea437e
  [Guido A.J. Stevens]

- remove duplicate field spec
  [Guido A.J. Stevens]

- pep8
  [Guido A.J. Stevens]

- fix view url error that only materializes under specific portlet configurations
  [Guido A.J. Stevens]

- add functional test coverage on comment editing
  [Guido A.J. Stevens]

- pep8
  [Guido A.J. Stevens]

- show author_name for anonymous commenters
  [Guido A.J. Stevens]

- fix usability issues, especially on older Plone versions
  [Guido A.J. Stevens]

- add some tests for editing of comments
  [Paul J Stevens]

- rebase
  [Paul J Stevens]

- support ownership of comments
  [Paul J Stevens]

- connect deleting comments to the zope2.DeleteObjects permission
  [Paul J Stevens]

- remove Owner from EditComments rolemap
  [Paul J Stevens]

- update control panel to enable editing of comments
  [Paul J Stevens]

- edit in overlay and redirect back to parent when done
  [Paul J Stevens]
...
- add and hookup tisto's EditCommentForm
  [Paul J Stevens]

- add and map EditComments permission
  [Paul J Stevens]
