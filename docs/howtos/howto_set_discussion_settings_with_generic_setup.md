...
myst:
  html_meta:
    "description": "How to set discussion settings with generic setup - plone.app.discussion documentation"
    "property=og:description": "How to set discussion settings with generic setup - plone.app.discussion documentation"
    "property=og:title": "How to set discussion settings with generic setup"
